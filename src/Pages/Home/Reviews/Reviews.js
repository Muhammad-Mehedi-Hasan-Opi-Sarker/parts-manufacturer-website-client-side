...
const Reviews = () => {
    return (
        <div>
            ...
            <div style={{ width: '240px', height: '300px' }} class="card opi mb-3 w-96 bg-primary text-primary-content">
                {/* avatar  */}
                <div class="avatar">
                ...
                <div class="card-body">
                    <h2 class="card-title">Boris Jonson</h2>
                    <p>The products here are very good. They deliver the product very
                        quickly. I already buy the products. </p>
                    
                </div>
            </div>
            <div  style={{ width: '240px', height: '300px',padding:'9px' }} class="card opi w-96 bg-primary text-primary-content">
                <div class="avatar">
                    <div class="w-24 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
            ...
            <div style={{ width: '240px', height: '300px',padding:'9px' }} class="card opi w-96 bg-primary text-primary-content">
                ...
                <div class="card-body">
                    <h2 class="card-title">Harry Protal</h2>
                    <p>I import products to my country every year from now on.
            ...
            <div style={{ width: '240px', height: '300px',padding:'9px' }} class="card opi w-96 bg-primary text-primary-content">
                ...
                <div class="card-body">
                    <h2 class="card-title">Ronaldo</h2>
                    <p>I import products to my country every year from now on.
                         The products here are very good</p>
